...
QUESTIONS = [
    ...
    },
    {
        ...
        "expected_answer": "You can't do it with a Lifecycle rule directly — Glacier Deep Archive transitions only go one way. You must first restore a temporary copy of the object, then use a copy operation to overwrite it specifying S3 Standard as the destination storage class.",
        "source": "s3_transitions.txt",
    },
    {
        "id": "o4",
    ...
    },
    {
        ...
        "expected_answer": "You start each day (UTC) with 4 available decreases, plus 1 more becomes available each hour up to a max of 4 available at any time — allowing up to 27 decreases over a full 24-hour day.",
        "source": "dynamodb_quotas.txt",
    },
    {
        "id": "o6",
